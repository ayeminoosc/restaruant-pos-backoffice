...
export default function OptionalInputBox({ label , placeHolder}: { label: string, placeHolder: string }) {
    return (
        <div className="w-full h-full flex flex-col gap-[1rem]">
            ...
            >
                {label}
                <div className="pt-1 text-[#C0C0C0] font-inter text-[1.25rem] font-medium leading-none">(Optional)</div>
