...
export default function AddingButton() {
    return (
        <div className="rounded-[10px] bg-[#FF6E30]
flex flex-col w-[242px] h-[56px] p-2.5 justify-center items-center gap-2.5 shrink-0">
            <svg
            ...
            <div className="text-white font-inter text-[20px] font-medium leading-[24px] tracking-[0.5px]"
            >Add Menu Item</div>
        </div>
    );
}
